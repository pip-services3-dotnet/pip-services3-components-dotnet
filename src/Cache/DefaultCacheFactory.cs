...
namespace PipServices3.Components.Cache
{
    ...
    {
        public static Descriptor Descriptor = new Descriptor("pip-services3", "factory", "cache", "default", "1.0");
        public static Descriptor NullCacheDescriptor = new Descriptor("pip-services3", "cache", "null", "*", "1.0");
        public static Descriptor NullCacheDescriptor2 = new Descriptor("pip-services3-commons", "cache", "null", "*", "1.0");
        public static Descriptor MemoryCacheDescriptor = new Descriptor("pip-services3", "cache", "memory", "*", "1.0");
        public static Descriptor MemoryCacheDescriptor2 = new Descriptor("pip-services3-commons", "cache", "memory", "*", "1.0");
