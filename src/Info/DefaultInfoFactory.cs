...
namespace PipServices3.Components.Info
{
    ...
    {
        public static readonly Descriptor Descriptor = new Descriptor("pip-services3", "factory", "info", "default", "1.0");
        public static Descriptor ContextInfoDescriptor = new Descriptor("pip-services3", "context-info", "default", "*", "1.0");
        public static Descriptor ContainerInfoDescriptor = new Descriptor("pip-services3", "container-info", "default", "*", "1.0");
        public static Descriptor ContainerInfoDescriptor2 = new Descriptor("pip-services3-container", "container-info", "default", "*", "1.0");
